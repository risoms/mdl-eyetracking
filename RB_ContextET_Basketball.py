...
################################################################################################
print('##########################################################################')
print('manually adding dominant eye')
print('##########################################################################')
expInfo['dominant eye'] = 'left'
################################################################################################
################################################################################################
################################################################################################
################################################################################################
...
# calibrating eyetracker
eyetracking.calibrate(window=win, drift=0)
################################################################################################
################################################################################################
################################################################################################
################################################################################################
...
thisExp.nextEntry()
# the Routine "endPracticeLrn" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
eyetracking.finish_recording(edfpath)
